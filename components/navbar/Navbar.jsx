...
function Navbar() {
  return (
    <header className="sticky top-0 flex shadow-md max-w-6xl w-full items-center justify-between  text-sm   bg-orange-500  h-16 border px-4  z-50">
      ...
      <p className="text-2xl text-primary-foreground font-bold  py-1 border-red-500 ">
